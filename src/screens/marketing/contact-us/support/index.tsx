...
const ContactForSupport: React.FC = () => {
    ...
    return (
        <section>
            <ContentMarketingHeading>
                ...
                <p>Have an issue that isn't covered in our <a href="#">extensive documentation</a>? Fill in the form below and we'll get back to you, in a snap!</p>
            </ContentMarketingHeading>
